...
cells = [
    {
        ...
        'metadata': {},
        'source': [
            '# 🏛️ Thesis Preparation Phase: Statutory Data Preprocessing & Unsupervised Legal Topic Modeling\n',
    ...
    },
    {
        ...
        'source': [
            ...
            '#@title 🔍 Trace Statute or Predict Draft Ordinance Category\n',
...
nb_path = os.path.join('notebooks', '01_corpus_preparation_and_topic_modeling.ipynb')
with open(nb_path, 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=2)

print(f"Successfully created: {nb_path}")
