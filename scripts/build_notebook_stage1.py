...
cells = [
    ...
    },
    {
        ...
        'outputs': [],
        'source': [
            '# Cell 6: Precompute Dense Embeddings for all 176,421 Provisions on Colab GPU\n',
            'import torch\n',
            ...
            '\n',
            '# Run high-throughput GPU batch encoding (takes ~2 minutes on T4 GPU)\n',
            '!python scripts/precompute_dual_corpus_embeddings.py --batch-size 512\n'
        ]
    }
]
