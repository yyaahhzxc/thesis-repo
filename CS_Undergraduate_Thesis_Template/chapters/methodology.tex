...
def extract_statutory_corpus(base_url, start_year=1900, end_year=2026):
    ...
    return statute_records
        ...
        \subsubsection{Municipal Corpus Analysis and Typology}
        ...
        \begin{figure}[!htbp]
            ...
            \caption{Chronological Distribution across Four Enactment Eras and Municipal Functional Typology Share of the Davao City Local Legislative Corpus ($N = 1,664$).}
            \label{fig:local_ordinance_temporal_and_typology}
        \end{figure}

        An unsupervised lexical clustering of the municipal collection revealed that city legislation divides into six functional archetypes. Under the Local Government Code of 1991~\cite{philgov1991ra7160}, city councils exercise both general regulatory powers and specific administrative responsibilities. Table~\ref{tab:local_typology_composition} provides a breakdown of the municipal collection across these six functional categories. Figure~\ref{fig:local_ordinance_temporal_and_typology}(b) illustrates the relative share of each discovered legislative archetype.
        ...
        \begin{table}[!htbp]
            ...
            \caption{Composition and Functional Typology of the Davao City Municipal Legislative Corpus ($N = 1,664$)}
            \label{tab:local_typology_composition}
            \begin{tabularx}{\linewidth}{c>{\RaggedRight}p{4.2cm}rr>{\RaggedRight}p{2.6cm}>{\RaggedRight}X}
                \toprule
                \textbf{ID} & \textbf{Functional Legislative Typology} & \textbf{Count} & \textbf{Share} & \textbf{Statutory Authority} & \textbf{Core Subject Matter} \\
                \midrule
                01 & Substantive Regulatory \& Penal & 684 & 41.11\% & RA 7160 \S458 & Traffic, zoning, public health, safety, and curfew codes \\
                02 & Inter-Agency Agreements (MOA/MOU) & 481 & 28.91\% & RA 7160 \S\S22(c), 455 & Mayoral authority to sign accords with national agencies \\
                03 & Disaster Relief \& QRF Funds & 189 & 11.36\% & RA 10121 \S21 & Quick Response Fund releases and calamity subsidies \\
                04 & Deeds of Donation \& Usufruct & 140 & 8.41\% & RA 7160 \S22(a)(4) & School site usufructs, donated roads, and open spaces \\
                05 & Temporary Road Closures & 122 & 7.33\% & RA 7160 \S21 & Street closures for festivals, athletics, and civil works \\
                06 & Zoning \& Subdivision Permits & 48 & 2.88\% & RA 7160 \S20, BP 220 & Agricultural reclassifications and housing permits \\
                \midrule
        ...
        Document lengths in the municipal collection differ noticeably from national statutes. Across all 1,664 local enactments, ordinances exhibit a median length of 5,644 characters and 880 words, with an interquartile range of 736 to 1,607 words. Brief commendations and routine road closure resolutions fall as low as 193 words. In contrast, comprehensive regulatory codifications reach up to 31,054 words in the \textit{Davao City Comprehensive Zoning Ordinance}. Because municipal enactments concentrate within concise regulatory bounds, they present fewer long-context challenges than national omnibus codes.

        \subsubsection{Dual Statutory Corpus Integration}
        \label{sec:dual_corpus_integration}
        Combining national legislation with Davao City municipal enactments establishes a unified search space of \textbf{27,096 legal records}. In automated statutory conflict detection, evaluating draft measures requires examining both vertical statutory preemption and horizontal legislative consistency. Under the doctrine of statutory preemption articulated in \textit{Magtajas v. Pryce Properties}~\cite{scp1994magtajasvpryce}, local measures are tested against the 25,432 superior national statutes. Concurrently, under intra-jurisdictional coherence principles, draft measures are evaluated against the 1,664 existing city ordinances to prevent conflicting local commands, duplicate penalties, or unintended implied repeals. Table~\ref{tab:dual_corpus_comparison} summarizes the empirical parameters and comparative characteristics of the two statutory sources.
        ...
        \begin{figure}[!htbp]
            ...
            \caption{Enactment Length Asymmetry (Full Text) and Provision-Level Cumulative 512-Token Compliance Curves across the Dual Statutory Search Space ($N = 27,096$ Enactments, $N_{\text{sections}} = 176,421$).}
