...
\begin{table}[!htbp]
    ...
    \begin{tabularx}{\linewidth}{>{\centering\arraybackslash}p{1.2cm}>{\centering\arraybackslash}p{1.4cm}>{\centering\arraybackslash}p{1.5cm}>{\centering\arraybackslash}p{1.3cm}>{\centering\arraybackslash}p{1.3cm}>{\RaggedRight}X}
        \toprule
