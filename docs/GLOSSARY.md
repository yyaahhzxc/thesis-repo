...
* **In This Thesis:** Compiled in `data/tier3_jurisprudential_cases.jsonl` and stored in `corpus/davao_city_tier3_ordinances/`, spanning 10 landmark Davao City municipal enactments:
  ...
  9. ***Davao Speed Limit Ordinance* (2023):** Davao City Ordinance No. 0270-23 establishing road speed classifications is valid pursuant to delegated authority under RA 4136 §38 and Joint DOTr-DPWH-DILG JAO 2018-01 (`Entailment`).
  10. ***Davao Firecracker Ban Ordinance* (2002):** Davao City Ordinance No. 060-02 imposing a total ban on pyrotechnics is a valid municipal exercise of general welfare police power to protect life and safety under RA 7160 §16 and §458(a)(1)(vi) (`Entailment`).

### **Direct Normative Preemption vs. Longitudinal Tax Construction**
