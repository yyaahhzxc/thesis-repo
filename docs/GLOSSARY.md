...
* **In This Thesis:** Compiled in `data/tier3_jurisprudential_cases.jsonl` and stored in `corpus/davao_city_tier3_ordinances/`, spanning eight landmark Davao City municipal enactments evenly balanced across four Contradictions and four Entailments:
  ...
  4. ***City of Davao v. First Meridian Development, Inc.* (2022):** Section 423 of Davao City Ordinance No. 158-05 was struck down as ultra vires for requiring mandatory "payment under protest" for local business tax disputes, which directly contradicts Section 195 of RA 7160 (which omits that requirement for business tax appeals, unlike Section 252 for real property taxes) (`Contradiction`).
  5. ***City of Davao v. Court of Appeals and GSIS* (2005):** Upheld Davao City's real property tax assessments on commercial properties of the Government Service Insurance System, confirming that Sections 193 and 234 of the Local Government Code of 1991 (RA 7160) expressly withdrew the tax exemptions of government-owned and controlled corporations (`Entailment`).
  6. ***Davao City Mining Ban Dispute* (2015):** The territorial mining prohibition under Ordinance No. 0310-07 operates in direct vertical tension with State mineral ownership and concessions under RA 7942 (`Contradiction` / Vertical Tension).
  7. ***Davao Anti-Smoking Ordinance* (2012):** Stricter local smoking setbacks under Ordinance No. 0367-12 are valid police power measures because national tobacco law (RA 9211) establishes minimum health baselines, not maximum ceilings (`Entailment`).
  8. ***Davao Speed Limit Ordinance* (2023):** Davao City Ordinance No. 0270-23 establishing road speed classifications is valid pursuant to delegated authority under RA 4136 §38 and Joint DOTr-DPWH-DILG JAO 2018-01 (`Entailment`).
